...
<label>est va enlasada con Consulta_Odontologica</label>


<label>Cedula:</label>
<input type="text" name="" placeholder="int  sera la cedula del doctor">
...
<a href="RecetarOdonto.jsp" class="btn">Recetar</a>
